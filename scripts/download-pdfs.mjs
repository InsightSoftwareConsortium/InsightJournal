...
/**
 * Script to download article PDFs from the Insight Journal website
 * Downloads PDFs from publication IDs 9 to 899
 */
...
async function main() {
  ...
  console.log(`   Range: Publication ${START_ID} to ${END_ID}`);
